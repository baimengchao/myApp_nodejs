...
fis.set('project.ignore', ['/fis-conf.js', '/css/**.less', '/node_modules/**', '/**/**.cs','/widget','.jshintrc','**eb.*.config']);
...
fis.media('pub').match('/widget/aio.js', {
    optimizer: fis.plugin('uglify-js'),
    useHash: true
});
...
fis.media('pub').match('/css/style.css', {
